...
export default {
  ...
  methods: {
    ...
    async registrarProducao() {
      if (this.nomeProd_Criado[0].nome_produto == "" || this.nomeProd_Criado[0].quantidade_produzida == 0 
          || this.n_producao == "" || this.data_inicio == "" || 
          this.data_fim == "" || this.objetivo == "" 
          || this.nomeAuxiliares.length == 0 || this.nomeTecnicos.length == 0 
          || this.ingredientesUtili[0].nome_ingrediente == "" || this.ingredientesUtili[0].quantidade == 0) {
